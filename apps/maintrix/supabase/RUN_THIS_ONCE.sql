...
-- ═══════════════════════════════════════════════════════════════
-- This is migrations 0009 through 0015 concatenated in order, exactly as
-- they exist in supabase/migrations/. 0009-0014 have already been run
-- against production; 0015 (voice channels, DM notifications, streaks,
-- badge auto-awards, maintenance banner, admin debate deletion, admin
-- grants) has not — this file is idempotent, so running the whole thing
-- again is safe.
--
...
--
-- After this runs, also double check the one-off grants near the bottom
-- (handles 'ret' and '5') — they only take effect if those handles match
-- exactly and those accounts have already signed up.
-- ═══════════════════════════════════════════════════════════════
